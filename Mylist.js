...
const Mylist = () => {
  ...
  const addToList = async (movie) => {
    try {
      ...
      if (user) {
        ...
        const existingMovie = myListMovies.find(item => item.youtubeVideoUrl === movie.youtubeVideoUrl);
        if (existingMovie) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Movies You've Added To Your List</Text>
      <FlatList
        data={myListMovies}
